      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <FooterColumn title="Услуги">
            <FooterLink href="#">Подбор оборудования</FooterLink>
            <FooterLink href="#">Поставка и монтаж</FooterLink>
            <FooterLink href="#">Сервисное обслуживание</FooterLink>
            <FooterLink href="#">Работа с госзаказчиками</FooterLink>
          </FooterColumn>
